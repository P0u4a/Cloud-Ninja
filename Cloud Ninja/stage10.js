class stage10 extends Phaser.Scene {
    constructor() {
        super({key: "stage10"})
    }
    ...
    create() {
        ...
        player = this.physics.add.sprite(700, 170, "mc");
        ...
        checkpoint.create(55, 75, "portal");
