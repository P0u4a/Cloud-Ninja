class stage17 extends Phaser.Scene {
    constructor() {
        super({key: "stage17"})
    }
    ...
    create() {
        ...
        platforms.create(65, 150, "platform");

        player = this.physics.add.sprite(65, 120, "mc");

        movingplatform = this.physics.add.sprite(220, 150, "platform2");
        movingplatform.body.allowGravity = false
        movingplatform.body.immovable = false
        movingplatform.body.collideWorldBounds = false

        movingplatform2 = this.physics.add.sprite(300, 300, "platform2");
        movingplatform2.body.allowGravity = false
        movingplatform2.body.immovable = false
        movingplatform2.body.collideWorldBounds = false

        movingplatform3 = this.physics.add.sprite(600, 230, "platform2");
        ...
        function lightningGen() {
            ...
            obstacles.create(670, 1, "lightning")
        ...
        checkpoint.create(720, 130, "portal");
