class stage6 extends Phaser.Scene {
    ...
    create() {
        ...
        movingplatform = this.physics.add.sprite(700, 255, "platform");
        ...
        movingplatform2 = this.physics.add.sprite(65, 100, "platform");
        ...
        checkpoint.create(65, 67, "portal");
