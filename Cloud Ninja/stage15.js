class stage15 extends Phaser.Scene {
    constructor() {
        super({key: "stage15"})
    }
    ...
    create() {
        ...
        function lightningGen() {
            ...
            obstacles.create(685, 1, "lightning")
        ...
        checkpoint.create(740, 40, "portal");
