class stage19 extends Phaser.Scene {
    constructor() {
        super({key: "stage19"})
    }
    ...
    create() {
        ...
        platforms.create(65, 200, "platform");

        movingplatform = this.physics.add.sprite(200, 300, "platform3");
        movingplatform.body.allowGravity = false
        movingplatform.body.immovable = true
        movingplatform.body.collideWorldBounds = true
        movingplatform.body.velocity.y = -550
        movingplatform.body.bounce.setTo(0,1);

        movingplatform2 = this.physics.add.sprite(380, 300, "platform3");
        movingplatform2.body.allowGravity = false
        movingplatform2.body.immovable = true
        movingplatform2.body.collideWorldBounds = true
        movingplatform2.body.velocity.y = 550
        movingplatform2.body.bounce.setTo(0,1);

        movingplatform3 = this.physics.add.sprite(290, 200, "platform2");
        ...
        function lightningGen() {
            ...
            obstacles.create(660, 1, "lightning")
        ...
        checkpoint.create(600, 40, "portal");
